...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log("Fetching whoami from Maximo:", maximoUrl);
    ...
    console.log("Successfully fetched whoami from Maximo");
    console.log("Whoami data:", JSON.stringify(data, null, 2));
